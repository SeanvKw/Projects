...
PARAMS = {
    ...
    "symbol": STOCK_NAME,
    "datatype": "json",
    "apikey": str(os.environ.get("STOCKAPI"))


}
NEWS_PARAMS = {
    "apiKey": str(os.environ.get("NEWSAPI")),
...
positive_difference = (float(yesterday_closing_price) -
...
diff_percent = round(
    (positive_difference / float(yesterday_closing_price)) * 100)
